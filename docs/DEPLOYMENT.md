...
| --- | --- | --- |
| `web/dist/` | `<remote root>/` | https://inventory.aicountly.com |
| `server-php/` | `<remote root>/api/` | https://inventory.aicountly.com/api |
...
`https://inventory.aicountly.com/api/.env` unless Apache is told otherwise. `server-php`
