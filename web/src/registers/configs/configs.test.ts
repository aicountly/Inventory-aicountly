...
const summaries: Record<string, unknown> = {
  ...
  'stock-ageing': {
    ...
    buckets: {
      ...
      '31_60': { qty: 2, value: 20, items: 1 },
      '61_90': { qty: 2, value: 20, items: 1 },
      '91_180': { qty: 2, value: 20, items: 0 },
      '180_plus': { qty: 2, value: 20, items: 0 },
    },
    bucket_labels: {},
    as_of: '2026-09-14',
    weighted_age_days: 62,
    oldest_days: 240,
    by_health: {
      fresh: { items: 1, value: 10 },
      healthy: { items: 1, value: 20 },
      watch: { items: 0, value: 0 },
      slow: { items: 1, value: 20 },
      obsolete: { items: 0, value: 0 },
    },
    by_warehouse: [],
    by_item_group: [],
    age_bucket: null,
