...
export const APP_NAME = (import.meta.env.VITE_APP_NAME ?? 'Inventory').trim() || 'Inventory'
 ...
 * with the app on both inventory.aicountly.com and inventory.gh.aicountly.com. That
