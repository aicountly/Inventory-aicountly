                  ...
                  {components.map((line) => {
                    ...
                    return (
                      <tr key={line.key}>
                        ...
                        {!costHidden ? (
                          <td className="px-2.5 py-1.5 text-right tabular-nums">
                            {rowCost?.amount != null ? formatAmount(rowCost.amount) : '—'}
                          </td>
                        ) : null}
                      </tr>
                    )
          ...
          <section className="rounded-lg border border-gray-200 bg-gray-50/70 px-3 py-2">
            ...
            <dl className="grid grid-cols-2 gap-x-4 gap-y-1 text-xs sm:grid-cols-3">
              <div className="flex justify-between gap-2">
                ...
                <dd className="font-semibold tabular-nums">{formatAmount(cost.componentCost)}</dd>
              </div>
              <div className="flex justify-between gap-2">
              ...
              <div className="flex justify-between gap-2">
                ...
                <dd className="font-semibold tabular-nums">
                  {cost.estimatedUnitCost === null ? '—' : formatAmount(cost.estimatedUnitCost)}
                </dd>
              </div>
            </dl>
            {cost.partial ? (
