 ...
 * the lines of all five documents are fetched in ONE batched call
 * (`GET /v1/inventory-documents/lines?document_ids=`) rather than five.
 *
  ...
  useEffect(() => {
    ...
    documentsApi
      ...
      .then(async (res) => {
        ...
        try {
          byDocument = await documentsApi.linesFor(
